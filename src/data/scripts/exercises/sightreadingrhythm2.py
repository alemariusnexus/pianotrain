...
class SightReadingRhythmExercise2(SingleLineSightReadingExercise):
    
    def __init__(self):
        SingleLineSightReadingExercise.__init__(self, "srr2", "Sight Reading Rhythm 2", "Sight Reading Rhythm",
...
ex = SightReadingRhythmExercise2()
